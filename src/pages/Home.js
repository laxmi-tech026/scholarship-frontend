...
function Home() {
  ...
  const scholarshipData = {
    ...
    Engineering: [
      ...
      { title: "M.Tech", amount: "1,00,000", marks: "85%", income: "Below 4 Lakh", duration: "4 years", seats: "120" },
      { title: "Diploma", amount: "50,000", marks: "75%", income: "Below 2 Lakh", duration: "2 years", seats: "150" },
    ],
    Medical: [
  ...
  const categoryIcons = { Government: "🏛️", Engineering: "⚙️", Medical: "🏥", Computer: "💻" };
